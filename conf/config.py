...
CENTRAL_WALLET = 'your_coin_address'                # Local coin address where money goes

COINDAEMON_TRUSTED_HOST = 'localhost'
COINDAEMON_TRUSTED_PORT = 35422
COINDAEMON_TRUSTED_USER = 'your_username'
COINDAEMON_TRUSTED_PASSWORD = 'your_username'
...
# scrypt, sha256d, scrypt-jane, skeinhash, quark, riecoin and a5a
